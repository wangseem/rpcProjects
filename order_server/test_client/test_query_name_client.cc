...
void test_client(const std::string& addr) {
  ...
  NEWMESSAGE(::queryNameReq, request);
  NEWMESSAGE(::queryNameRes, response);
  ...
  CALLRPRC(addr, QueryService_Stub, query_name, controller, request, response, closure);
