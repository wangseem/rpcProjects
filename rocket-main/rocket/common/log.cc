...
namespace rocket
{
    ...
    /**
     * @Author: kevin
     * @Date: 2023-09-04 21:13:49
     * @Description: logger构造
     * @param {LogLevel} level
     * @param {int} type
     * @return {*}
     */
    ...
    /**
     * @Author: kevin
     * @Date: 2023-09-04 21:14:48
     * @Description: 同步日志到异步日志队列里
     * @return {*}
     */    
    ...
    /**
     * @Author: kevin
     * @Date: 2023-09-04 21:15:05
     * @Description: 初始化全局logger
     * @param {int} type
     * @return {*}
     */    
    ...
    /**
     * @Author: kevin
     * @Date: 2023-09-04 19:30:21
     * @Description: 将日志转换为字符串，
     * @return {*}
     */    
...
/*-------------------------------------------------------------------------------------------------------------*/
    ...
    /**
     * @Author: kevin
     * @Date: 2023-09-04 21:21:37
     * @Description: 将 buffer 里面的全部数据打印到文件中，然后线程睡眠，直到有新的数据再重复这个过程
     * @param {void} *arg
     * @return {*}
     */
